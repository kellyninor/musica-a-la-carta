...
# Modelo
def system_svd(df, generos_usuario, seleccion_usuario, n_components):
...
experiment = mlflow.set_experiment("M2 (Modelo SVD Descomposición de valores Singulares)")
...
with mlflow.start_run(experiment_id=experiment.experiment_id):
    ...
    recomendaciones = system_svd(df, generos_usuario = gener_user, seleccion_usuario = sentm_user, n_components = n_compt)
   ...
   # Registre los parámetros
    ...
    # Registre el modelo
    mlflow.sklearn.log_model(system_svd, "recomend-spotify-model")
